...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<GameService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
...
MockGameService getAndRegisterGameService() {
  _removeRegistrationIfExists<GameService>();
  final service = MockGameService();
  locator.registerSingleton<GameService>(service);
  return service;
}
// @stacked-mock-create
